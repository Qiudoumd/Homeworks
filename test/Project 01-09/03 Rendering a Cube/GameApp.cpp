...
bool GameApp::InitResource()
{
    ...
    VertexPosColor vertices[] =
    {
        ...
        { XMFLOAT3(0.0f, 0.0f, -1.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    ...
    //m_CBuffer.proj = XMMatrixTranspose(XMMatrixOrthographicLH(10, 10, 1.0f, 1000.0f));//立方投影
    m_CBuffer.proj = XMMatrixTranspose(XMMatrixPerspectiveFovLH(XM_PIDIV2, AspectRatio(), 1.0f, 1000.0f));//透视投影
